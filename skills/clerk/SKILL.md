...
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ |
| `clerk init`               | Scaffold Clerk into a project, or emit an agent handoff with `--prompt`.                                                                         | `--framework`, `--pm`, `--name` (with `--starter`), `--app`, `--prompt`, `--starter`, `-y`, `--no-skills`    |
...
| `clerk config patch`       | Partial update (PATCH) of instance config.                                                                                                       | `--app`, `--instance`, `--file`, `--json`, `--dry-run`, `--yes`, `--destructive`                             |
...
| `clerk update`             | Update the CLI to the latest version.                                                                                                            | `--channel`, `-y`                                                                                            |
