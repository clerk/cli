...
- `clerk branch create --name <name>` forks the development instance into a named branch. `--switch` (`-s`) also activates the new branch for the current worktree in one step.
