  ...
  return `// !$*UTF8*$!
{
  ...
  objects = {
    ...
    ${IDS.targetRelease} = { isa = XCBuildConfiguration; ${baseConfigurationReference} buildSettings = { GENERATE_INFOPLIST_FILE = YES; ${releaseEntitlements} ${releaseIdentitySettings} ${deploymentTargetSetting} ${sandboxSettings} SUPPORTED_PLATFORMS = "${supportedPlatforms}"; }; name = Release; };
